...
const Login = () => {
    ...
    const { states, setters, login } = useContext(AuthContext)
    ...
    const action = (e) => {
        e.preventDefault()
        login()
        states.signed && hist('/home')
        /*        
           states.signed ? hist('/home') : alert('Email ou senha inválidos')
            Funcao original:
            if(states.signed){
                hist('/home')
            }
            ...
            <div className="flex min-h-full flex-col justify-center py-12 sm:px-6 lg:px-8">
                ...
                <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
                    <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
                        <form className="space-y-6" action="#" method="POST" onSubmit={action}>
                            <div>
